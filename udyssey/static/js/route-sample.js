/**
 * This is an example of route displaying on front-end web page.
 * This should by only used as a reference for our Udyssey project.
 * You can checkout the demo at here: http://rhiever.github.io/optimal-roadtrip-usa/major-landmarks.html
 *
...
// This is a display option for Google Maps DirectionsRenderer service.
...
// This will initialize the route on the map.
function initialize() {
  ...
  // Since at most 10 locations can be displayed with Directions service at each time
  // We need to call this as much as number of our locations.
...
// This binds route to the Directions service.
...
// Maximum 10 locations can be displayed with Directions service at a time.
calcRoute("Grand Canyon National Park Lodges, 88 Village Loop Drive, Grand Canyon Village, AZ 86023",
  "Graceland, Elvis Presley Boulevard, Memphis, TN", ["Bryce Canyon National Park, Hwy 63, Bryce, UT",
...
calcRoute("Graceland, Elvis Presley Boulevard, Memphis, TN",
  "Mount Vernon, Fairfax County, Virginia", ["Vicksburg National Military Park, Clay Street, Vicksburg, MS",
...
calcRoute("Mount Vernon, Fairfax County, Virginia",
  "USS Constitution, Boston, MA", ["White House, Pennsylvania Avenue Northwest, Washington, DC",
...
calcRoute("USS Constitution, Boston, MA",
  "Lincoln Home National Historic Site Visitor Center, 426 South 7th Street, Springfield, IL", ["Acadia National Park, Maine",
...
calcRoute("Lincoln Home National Historic Site Visitor Center, 426 South 7th Street, Springfield, IL",
  "Glacier National Park, 64 Grinnell Drive, West Glacier, MT 59936", ["Gateway Arch, Washington Avenue, St Louis, MO",
...
calcRoute("Glacier National Park, 64 Grinnell Drive, West Glacier, MT 59936",
  "Grand Canyon National Park Lodges, 88 Village Loop Drive, Grand Canyon Village, AZ 86023", ["Hanford Site, Benton County, WA",
